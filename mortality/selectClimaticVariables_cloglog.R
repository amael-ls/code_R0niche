...
if (formula_id == 1)
{
	model = stan_glmer(formula = deltaState ~ 1 + (1 | plot_id) +
		...
		family = binomial(link = "cloglog"), offset = log(deltaYear), iter = 2000, cores = 4, chains = 4,
		prior = normal(),
		...
		algorithm = "sampling")
		saveRDS(model, paste0(savePath, "model_1_cloglog_fullData.rds"))
}
...
if (formula_id == 2)
{
	model = stan_glmer(formula = deltaState ~ 1 + (1 | plot_id) +
		...
		# diagnostic_file = paste0(savePath, "diagnostic", formula_id, ".csv"),
		algorithm = "sampling")
		saveRDS(model, paste0(savePath, "model_2_cloglog_fullData.rds"))
}
...
if (formula_id == 3)
{
	model = stan_glmer(formula = deltaState ~ 1 + (1 | plot_id) +
		...
		# diagnostic_file = paste0(savePath, "diagnostic", formula_id, ".csv"),
		algorithm = "sampling")
		saveRDS(model, paste0(savePath, "model_3_cloglog_fullData.rds"))
}
...
if (formula_id == 4)
{
	model = stan_glmer(formula = deltaState ~ 1 + (1 | plot_id) +
		...
		# diagnostic_file = paste0(savePath, "diagnostic", formula_id, ".csv"),
		algorithm = "sampling")
		saveRDS(model, paste0(savePath, "model_4_cloglog_fullData.rds"))
}
...
if (formula_id == 5)
{
	model = stan_glmer(formula = deltaState ~ 1 + (1 | plot_id) +
		...
		# diagnostic_file = paste0(savePath, "diagnostic", formula_id, ".csv"),
		algorithm = "sampling")
		saveRDS(model, paste0(savePath, "model_5_cloglog_fullData.rds"))
}
...
if (formula_id == 6)
{
	model = stan_glmer(formula = deltaState ~ 1 + (1 | plot_id) +
		...
		# diagnostic_file = paste0(savePath, "diagnostic", formula_id, ".csv"),
		algorithm = "sampling")
		saveRDS(model, paste0(savePath, "model_6_cloglog_fullData.rds"))
}
...
if (formula_id == 7)
{
	model = stan_glmer(formula = deltaState ~ 1 + (1 | plot_id) +
		...
		# diagnostic_file = paste0(savePath, "diagnostic", formula_id, ".csv"),
		algorithm = "sampling")
		saveRDS(model, paste0(savePath, "model_7_cloglog_fullData.rds"))
}
